...
_From the output above, we see "Precision", "Recall", and "f1-Score". We see the biggest difference between our precision, which means our model is more likely to predict that a house is before1980 when it isnt._
